        ...
        <div className="px-5 py-4 flex items-center gap-5 flex-wrap lg:flex-nowrap">
          ...
          <div className="flex-shrink-0 min-w-[180px]">
            ...
            <div className="mt-2 flex items-center gap-4 text-[11px] tabular-nums">
              ...
              <div className="flex items-center gap-1.5">
                <span className="text-red-400/60">Erlos</span>
                <span className="text-red-400/80">-{fmtInt(Math.round(benchmark.erlosverlust_euro))} EUR</span>
              </div>
              <div className="flex items-center gap-1.5">
                <span className="text-primary/60">Analysen</span>
                <span className="text-primary font-medium">
                  {fmtInt(benchmark.hauptpot_net_analysen)}
                  <span className="text-primary/60 font-normal ml-0.5">
                    ({benchmark.total_analysen > 0 ? fmtPct((benchmark.hauptpot_net_analysen / benchmark.total_analysen) * 100) : "0%"})
                  </span>
                </span>
              </div>
            </div>
